...
angular.module("MyApp", ["ngMaterial", "ngMessages"]).controller("AppCtrl", [
  ...
  function($scope, $mdDialog) {
    ...
    obj.forEach(function(e) {
      ...
      team_abbrev.push(e.abbreviation);
    ...
    $scope.showTeam = function(team, $index) {
      ...
      $scope.value = $scope.capValues[team + team_abbrev[$index]];
      ...
      function DialogController($scope, $mdDialog) {
        ...
        else $scope.capSpace.style = { color: "green" };
